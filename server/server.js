...
if (srvConfig.isHTTPS) {
    const privateKey = fs.readFileSync('/opt/psa/var/modules/letsencrypt/etc/live/dennerrondinely.com/privkey.pem', 'utf8');
    const certificate = fs.readFileSync('/opt/psa/var/modules/letsencrypt/etc/live/dennerrondinely.com/cert.pem', 'utf8');
    const ca = fs.readFileSync('/opt/psa/var/modules/letsencrypt/etc/live/dennerrondinely.com/chain.pem', 'utf8');
